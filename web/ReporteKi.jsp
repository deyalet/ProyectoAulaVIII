    ...
    <body class="is-preload">
        ...
        <script language="javascript">
            ...
            function exportTableToExcel(tableID, filename = '') {
                ...
                // Specify file name
                filename = filename ? filename + '.xls' : 'ReporteRecordatorio.xls';
        ...
        <div class="container">
            ...
            <button id="btnPDF" type="button" onclick='getPDF()'>Download pdf</button>
            <button id="btnExcel" type="button" onclick="exportTableToExcel('contentTable')">Export Excel</button><br><br>
