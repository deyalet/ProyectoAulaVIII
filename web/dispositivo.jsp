...
<html>
    ...
    <body class="is-preload" onload="main()">
        <header id="header" style="">
            ...
            <a class="logo center-align textgrueso " id="ulUserData"style="padding-top:6px; text-align:center; width:100%; font-size:20px; color:#ffffff" href="Principal.jsp">Assign Device</a>
        </header>
            ...
            <form class="col-12">
                <div class="row">
                    <div class="input-field col s6">
                        <input placeholder="Alias ​​for device" id="alias" type="text" required="true">
                ...
                <button type="button" class="btn waves-effect waves-light" id="btnaggdatosDispositivo" style="height:50px; width:100px; position: absolute;left:44%">Save</button>
            </form>
        </div>
