...
<html>
    ...
    <body class="is-preload">
        <header id="header" style="">
            ...
            <a class="logo center-align textgrueso " id="ulUserData"style="padding-top:6px; text-align:center; width:100%; font-size:20px; color:#707070" href="index.html">Update data</a>
        </header>
        <form class="col s12">
            <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s12" style="margin-left:350px; width: 350px;">
                        <input onblur="validar1()" maxlength="10" id="cedula" type="text" class="validate" placeholder="Identification" onkeypress='return validaNumericos(event)'>
        ...
        <script src="js/TraerDatosPacientes.js"></script>
