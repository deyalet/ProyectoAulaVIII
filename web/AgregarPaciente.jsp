...
<html>
    ...
    <body class="is-preload">
        <header id="header" style="">
            ...
            <a class="logo center-align textgrueso " id="ulUserData"style="padding-top:6px; text-align:center; width:100%; font-size:20px; color:#707070" href="index.html">REGISTER PATIENTS</a>
        </header>
        <form class="col s12">
            <div class="row">
                <div class="input-field col s6" style="margin-left:380px ; width: 350px">
                    <input  id="email" type="email" class="validate" placeholder="User">
                    <label for="email"></label>
                </div>
                <div class="input-field col s6" style="margin-left:20px ; width: 350px">
                    <input  id="pass" type="password" class="validate" placeholder="Password" >
                ...
                <div class="row">
                    <div class="input-field col s12" style="margin-left:350px; width: 350px;">
                        <input onblur="validar1()" maxlength="10" id="cedula" type="text" class="validate" placeholder="Indentification" onkeypress='return validaNumericos(event)'>
        ...
        <button onchange="validar()" onclick="enviar()" class="btn btn-primary btn-user btn-block" style="height:50px; width:100px; position: absolute;left:44%" >Send</button><br><br>
